...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      {/* Hero Section */}
      <section
        className="bg-yellow-400 text-black py-20 px-6"
        data-aos="fade-down"
      >
      ...
      >
        ...
        <div>
          <h2 className="text-2xl font-semibold text-yellow-600 mb-2">4. Cookies</h2>
          <p className="text-gray-800 leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-yellow-600 mb-2">5. Your Rights</h2>
          <p className="text-gray-800 leading-relaxed">
      ...
      {/* Footer CTA */}
      <section
        className="bg-yellow-400 text-black py-12 text-center px-6"
        data-aos="fade-up"
      >
